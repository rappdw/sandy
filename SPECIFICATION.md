...
│   ├── outbox/                # → /home/sandy/.handoff/outbox (rw)
│   ├── inbox/                 # → /home/sandy/.handoff/inbox (:ro)
...
| Field | Meaning |
|---|---|
| `schema` | Marker schema version (currently `1`; `effort`, `permission_mode`, `cross_session_inbound`, `handoff_relay`, `cred_mode`, `sandbox_name` and `agent_args` are all additive fields). |
